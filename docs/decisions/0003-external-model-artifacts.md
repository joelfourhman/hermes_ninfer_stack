...
`python stack.py setup` workflow prompts before downloading, while
`python stack.py download-model` remains an intentional standalone recovery command.
